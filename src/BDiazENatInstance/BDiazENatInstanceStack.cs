    ...
    public class BDiazENatInstanceStack : Stack
    {
        internal BDiazENatInstanceStack(Construct scope, string id, IStackProps props = null) : base(scope, id, props) {
            ...
            userData.AddCommands(
                ...
                "echo '{ \"agent\": { \"metrics_collection_interval\": 60, \"run_as_user\": \"cwagent\" }, \"metrics\": { \"aggregation_dimensions\": [ [ \"InstanceId\" ] ], \"metrics_collected\": { \"disk\": { \"measurement\": [ \"used_percent\" ], \"metrics_collection_interval\": 60, \"resources\": [ \"*\" ] }, \"mem\": { \"measurement\": [ \"mem_used_percent\" ], \"metrics_collection_interval\": 60 } } } }' | tee /opt/aws/amazon-cloudwatch-agent/etc/cloudwatch-agent.json",
